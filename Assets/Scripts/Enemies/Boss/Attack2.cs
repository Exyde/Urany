...
public class Attack2 : MonoBehaviour
{
    ...
    public GameObject exploseSpherePrefab;
    ...
    IEnumerator DoAttack()
    {
        ...
        for (int i = 0; i < sphereNumber; i++)
        {
            ...
            GameObject sphere = Instantiate(exploseSpherePrefab, spherePos, Quaternion.identity);
	   ...
	   {
            sphere.GetComponent<BigSphere>().Explode();
	   }
